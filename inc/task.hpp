...
public:
   ...
   */
  explicit Task(const std::string& task_name = "Task", const uint16_t stack_size = configMINIMAL_STACK_SIZE,
                const uint8_t priority = kTaskDefaultPriority, const BaseType_t core_id = 0);
